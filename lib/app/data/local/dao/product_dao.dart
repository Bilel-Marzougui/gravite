...
class ProductDatabaseHelper {
  ...
  DB database = DB();
  String nameTable = 'productTable';
  String colId = 'id';


  ProductDatabaseHelper._createInstance();
  static  ProductDatabaseHelper _databaseHelper = ProductDatabaseHelper._createInstance();

  factory ProductDatabaseHelper() {
    if (_databaseHelper == null) {
      _databaseHelper = ProductDatabaseHelper._createInstance();
    }
